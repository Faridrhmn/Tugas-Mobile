  ...
  _inputField(context) {
    ...
    return Column(
      ...
      children: [
        TextField(
          onChanged: (value) {
            // Update nilai username saat input berubah
            username = value;
          },
        ...
        ElevatedButton(
          onPressed: () {
            // Periksa jika username dan password adalah "admin"
            if ((username == "admin" && password == "admin") || (username == "032" && password == "032") || (username == "045" && password == "045") || (username == "183" && password == "183")) {
              Navigator.push(
                context,
